  ...
  head: () => ({
    meta: [
      ...
      { title: "Pães e Vinhos Padaria | Sudoeste, Brasília" },
      {
        name: "description",
        content:
          "Padaria, cafeteria, pizzaria e restaurante no Sudoeste, Brasília. Pães artesanais, refeições, pizzas, caldos e vinhos.",
      },
      { name: "author", content: "Pães e Vinhos Padaria" },
